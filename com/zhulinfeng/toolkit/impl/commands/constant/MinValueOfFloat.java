...
public class MinValueOfFloat implements Command {

    public ExecuteOutput execute(ArrayList<String> args) {
        return new CommandOutPut(String.valueOf(Float.MIN_VALUE) + "\n");
    }

    public String help() {
        return OutPutTable.getSummary("min value of float") + "none.\n";
    }
}
