...
public class MinValueOfLong implements Command {

    public ExecuteOutput execute(ArrayList<String> args) {
        return new CommandOutPut(String.valueOf(Long.MIN_VALUE) + "\n");
    }

    public String help() {
        return OutPutTable.getSummary("min value of long") + "none.\n";
    }
}
