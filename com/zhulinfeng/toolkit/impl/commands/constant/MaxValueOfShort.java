...
public class MaxValueOfShort implements Command {

    public ExecuteOutput execute(ArrayList<String> args) {
        return new CommandOutPut(String.valueOf(Short.MAX_VALUE) + "\n");
    }

    public String help() {
        return OutPutTable.getSummary("max value of short") + "none.\n";
    }
}
