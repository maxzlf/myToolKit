...
public class IntToHex implements Command {

    public ExecuteOutput execute(ArrayList<String> args) {
        String result;

        try {
            result = Long.toHexString(NumberMalipulations.turnStrToLong(args.get(0))) + "\n";
    ...
    public String help() {
        return OutPutTable.getSummary("int value [] to hex") + "none.\n";
    }
}
